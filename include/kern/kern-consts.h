...
#include <klib/misc.h>
#define KC_KSTACK_SIZE (CONFIG_HAL_PAGE_SIZE * (ULONGLONG_C(1) << CONFIG_KSTACK_PAGE_ORDER))
#define KC_ISTACK_SIZE (CONFIG_HAL_PAGE_SIZE * (ULONGLONG_C(1) << CONFIG_ISTACK_PAGE_ORDER))
